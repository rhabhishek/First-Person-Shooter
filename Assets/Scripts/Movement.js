...
function Update () 
{
   ...
   // forward.normalized;
	...
	{
	    rigidBody.AddRelativeForce(cScript.Controllers[0].JoystickX * playerAcceleration * jumpControl * Time.deltaTime, 0 , cScript.Controllers[0].JoystickY * playerAcceleration * jumpControl * Time.deltaTime);
	}
	if(cScript.Controllers[0].Trigger && grounded && !walking)
	{
